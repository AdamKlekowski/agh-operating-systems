/* (...) napisz program udpchat.c, który będzie służył do prowadzenia „rozmowy” pomiędzy dwiema instancjami programu.
Niech adres i port, na którym dany proces nasłuchuje oraz adres i port odbiorcy będą podane jako argumenty wywołania programu.
Zmodyfikuj program tak, aby działał w pętli.
Zakończenie działania następuje po odebraniu od współrozmówcy komunikatu: „bye”. */
